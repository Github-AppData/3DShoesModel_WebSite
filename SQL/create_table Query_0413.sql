...
CREATE TABLE IF NOT EXISTS `shoes_store`.`nonuser_orders` (
  ...
  `column_modified_date` DATETIME NOT NULL,
  `orders_quantity` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `shoes_store`.`shoes_question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shoes_store`.`shoes_question` (
  ...
  INDEX `fk_user_id_user` (`User_id` ASC) VISIBLE,
  INDEX `fk_shoes_id_shoes` (`Shoes_id` ASC) VISIBLE,
  CONSTRAINT `fk_shoes_id_shoes`
    FOREIGN KEY (`Shoes_id`)
    REFERENCES `shoes_store`.`shoes` (`shoes_id`),
...
-- -----------------------------------------------------
-- Table `shoes_store`.`shoes_question_answer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shoes_store`.`shoes_question_answer` (
  ...
  INDEX `fk_question_id_shoes_question_answer` (`Question_id` ASC) VISIBLE,
  CONSTRAINT `fk_question_id_shoes_question_answer`
    FOREIGN KEY (`Question_id`)
    REFERENCES `shoes_store`.`shoes_question` (`Question_Id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
